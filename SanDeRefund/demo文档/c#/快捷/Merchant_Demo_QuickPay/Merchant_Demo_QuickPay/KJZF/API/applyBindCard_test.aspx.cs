...
{
    public partial class applyBindCard_test : System.Web.UI.Page
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(applyBindCard_test));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.HttpMethod == "POST")
            {
                ...
                head["version"] = "1.0";
                head["method"] = "sandPay.fastPay.apiPay.applyBindCard";
