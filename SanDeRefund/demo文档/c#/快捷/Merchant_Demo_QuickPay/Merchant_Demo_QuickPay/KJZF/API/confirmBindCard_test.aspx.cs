...
{
    public partial class confirmBindCard_test : System.Web.UI.Page
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(confirmBindCard_test));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.HttpMethod == "POST")
            {
                ...
                head["version"] = "1.0";
                head["method"] = "sandPay.fastPay.apiPay.confirmBindCard";
                ...
                body["sdMsgNo"] = Request.Form["sdMsgNo"];
                body["phoneNo"] = Request.Form["phoneNo"];
                body["smsCode"] = Request.Form["smsCode"];
