<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bindCard_test.aspx.cs" Inherits="WebApplication1.KJZF.API.bindCard_test" %>
...
<body onload="load()">
    <div>
        <form id="form_query" method="post" onsubmit="return check()">
            ...
            <br />
            请求地址<input type="text" name="urlstring" id="urlstring" value="http://61.129.71.103:8003/fastPay/apiPay/bindCard" style="width:600px" /><br />
            <br />
            商户号
