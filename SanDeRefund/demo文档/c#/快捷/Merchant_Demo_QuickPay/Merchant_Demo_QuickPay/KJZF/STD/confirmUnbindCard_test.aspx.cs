...
namespace Merchant_Demo_QuickPay.KJZF.STD_TEST
{
    public partial class confirmUnbindCard_test : System.Web.UI.Page
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(confirmUnbindCard_test));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.HttpMethod == "POST")
            {
                ...
                head["version"] = "1.0";
                head["method"] = "sandPay.fastPay.apiPay.unbindCard";
