<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirmUnbindCard_test.aspx.cs" Inherits="Merchant_Demo_QuickPay.KJZF.STD_TEST.confirmUnbindCard_test" %>
...
<body onload="load()">
    <div>
        <form id="form_query" method="post" onsubmit="return check()">
            ...
            地址<input type="text" name="urlstring" id="urlstring" value="http://61.129.71.103:8003/fastPay/apiPay/unbindCard" style="width: 600px" /><br />
            <br />
            商户号
